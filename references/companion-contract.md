...
- A working prop surface uses readable text, pseudo-writing, handwriting, numbers, letters, code lines, UI paragraphs, ruled notebook lines, list rows, or a tiny-document look instead of chunky non-text progress blocks, dots, check marks, sliders, or sorting tokens.
